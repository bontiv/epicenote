                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            {* Next User mkurl action="user" page="edit" user=$line.user_id *}
                            <a href="{mkurl action="admin_modeles" modele="users" page="modinst" key=$line.user_id}" class="btn btn-warning"><i class="glyphicon glyphicon-pencil"></i></a>
